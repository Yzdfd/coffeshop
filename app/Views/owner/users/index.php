...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white py-3">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
            <a href="<?= base_url('owner/users/create') ?>" class="btn btn-primary btn-sm">
                    ...
                    <?php else: ?>
                        <?php $no = 1; foreach ($users as $u): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('owner/users/edit/' . $u['id']) ?>" class="btn btn-secondary btn-sm" title="Edit">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <a href="<?= base_url('owner/users/reset-password/' . $u['id']) ?>"
                                    ...
                                    <?php if ((int)$u['id'] !== (int)session('user_id')): ?>
                                        <?php if (($u['status'] ?? '') === 'aktif'): ?>
                                            <a href="<?= base_url('owner/users/toggle/' . $u['id']) ?>"
                                        ...
                                        <?php endif; ?>
                                        <a href="<?= base_url('owner/users/delete/' . $u['id']) ?>"
