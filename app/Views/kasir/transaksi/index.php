        ...
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <div class="fw-bold" style="font-size:15px">Rp
                        <?= number_format($totalPendapatan ?? 0, 0, ',', '.') ?></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <div class="fw-bold" style="font-size:15px">Rp <?= number_format($totalCash ?? 0, 0, ',', '.') ?>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <div class="fw-bold" style="font-size:15px">Rp <?= number_format($totalNonCash ?? 0, 0, ',', '.') ?>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="table-responsive">
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="9" class="text-center text-muted py-4">Tidak ada transaksi.</td>
                    </tr>
                    <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td><a
                                href="<?= base_url('kasir/pesanan/detail/' . $t['order_id']) ?>">#<?= $t['order_id'] ?></a>
                        </td>
                        ...
                        <td>
                            ...
                            <!-- base_url('kasir/transaksi/print/' . $t['id']) -->
