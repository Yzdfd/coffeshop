        ...
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <div class="fw-bold" style="font-size:16px">Rp <?= number_format($pendapatanHari ?? 0, 0, ',', '.') ?></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="table-responsive">
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr><td colspan="6" class="text-center text-muted py-4">Tidak ada pesanan aktif.</td></tr>
                    <?php else: ?>
